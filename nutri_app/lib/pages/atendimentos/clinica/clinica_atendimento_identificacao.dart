...
class ClinicaAtendimentoIdentificacaoPage extends StatefulWidget {
  const ClinicaAtendimentoIdentificacaoPage({super.key});

  @override
  _ClinicaAtendimentoIdentificacaoPageState createState() => _ClinicaAtendimentoIdentificacaoPageState();
}

class _ClinicaAtendimentoIdentificacaoPageState extends State<ClinicaAtendimentoIdentificacaoPage> {
